...
# fluid_force = 0.000085      # Re=0,07
# fluid_force = 0.000081
# fluid_force = 0.00057     # Re=0,52
# fluid_force = 0.0016      # Re=1,5
fluid_force = 0.0011      # Re=1
time_step = 0.05
# time_step = 0.1
...
# allowed_overlap = 0.2   # povoleny prekryv buniek pri seedingu
#
# for k in range(0,num_cells,1):
#     origin_ok = 0
#     sim_info = open(directory + "/sim_info.dat", "a")
...
for i in range(2,len(sys.argv)):
    for k in range(int(sys.argv[i])):
        ...
        j = j + 1
# print("cell_types2: " + str(cell_types2))
...
# Pre seeding z nodes.dat       **********************************************************************************************************************************TREBA UPRAVIT
# for id, pos in enumerate(cell_positions):
#     if id < diffCells:
...
################################################################# start - save seeding of particles to dat file
particles_cell = list()
