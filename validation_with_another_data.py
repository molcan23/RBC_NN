...
def dataset_creation(mod=None, ts_length=None):
    #print(cs.TS_LENGTH)
    df_all = pd.DataFrame()
    rbc_coefficients = []
    number_of_cells = 0
    ...
    for variables in [[3, 31], [5, 52], [10, 105], [20, 212], [30, 318], [40, 425], [50, 531]]:
        ...
        for model_type in [f'weights_CNN-LSTM_Conv1D_{s}.h5',
            ...
            if model_type == f'weights_LSTM_{s}.h5':
                X, y = dataset_creation(mod="LSTM", ts_length=s)
                ...
                X, y = dataset_creation(ts_length=s)
            ...
            results_table.append([s, model_type[8:-5].strip("_"), score[0]])
...
#                print()
    ...
    plt.title("Validation of models for xy_xz data")
